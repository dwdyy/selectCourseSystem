...
public:
	...
	// 按照课程编号选课
    bool SelectCourse(CourseData& cData, StudentCourseData& scData, const Student& user,std::string courseNumTemp);
    bool DeleteCourse(CourseData& cData, StudentCourseData& scData, const Student& user,std::string courseNumTemp);
	// 查看已选课程信息和累计学分
...
public:
	...
	// 删除学生信息
    bool Manage_Delete(StudentData& sData, StudentCourseData& scData, CourseData& cData,std::string stuID);
	// 修改学生信息
	...
	// 删除课程信息
    void Manage_Delete(CourseData& cData, StudentCourseData& scData,std::string courseNum);
	// 修改课程信息
    ...
    // 删除学生数据不删除选课数据
    bool Manage_Delete_nonecourse(StudentData& sData, StudentCourseData& scData, CourseData& cData,std::string stuID);
};
